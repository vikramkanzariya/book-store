  ...
  return (
    <>
      <TableContainer sx={{ "&::-webkit-scrollbar": { display: 'none' }, width: '99%' }} component={Paper}>
        <Typography variant='h3' sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', width: '100%', backgroundColor: theme.palette.primary.light, textAlign: 'center', margin: '10px', borderRadius: '10px', boxSizing: 'border-box' }}>
          BookList
          <Button variant='outlined' onClick={addBookFun} sx={{ width: { xs: 'fit-content', md: '150px' }, position: 'absolute', right: '0', color: "white", borderColor: "white", }} >Add New Book</Button>
        </Typography>
      ...
      >
        <Box sx={style}>
          ...
          {/* <Typography id="modal-modal-title" variant="h6" component="h2">
            ...
            /> */}
          <Button onClick={() => editBookRequest()} sx={{ marginTop: "20px", fontFamily: 'Josefin Sans' }} color="primary" variant="contained" type="submit">
            Submit
          </Button>
        </Box>
      </Modal>
