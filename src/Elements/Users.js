...
const Users = () => {
  ...
  return (
    <TableContainer sx={{ marginTop: '10px', marginBottom: '30px' }} component={Paper}>
      <Typography variant='h2' sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', width: '95%', backgroundColor: theme.palette.primary.light, textAlign: 'center', margin: '10px', borderRadius: '10px' }}>
        Users
      </Typography>
