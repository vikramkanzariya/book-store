          ...
          <Toolbar sx={{ position: 'relative' }}>
            ...
            <Box id='routedBtns' sx={{ display: { xs: 'none', sm: 'flex' }, zIndex: 1, boxShadow: { xs: 3, sm: 0 }, borderRadius: { xs: '5px', sm: 0 }, width: { xs: '75px', sm: 'fit-content' }, alignItems: 'center', justifyContent: 'space-between', flexDirection: { xs: 'column', sm: 'row' }, position: { xs: 'absolute', sm: 'static' }, top: { xs: '60px' }, left: { xs: '5px' }, zIndex: { xs: '1' }, backgroundColor: theme.palette.primary.main }}>
              <Typography
                ...
                noWrap
                component="div"
                sx={{ display: { xs: 'block', sm: 'block' }, userSelect: 'none', borderRadius: '10px', marginRight: { md: "10px" }, cursor: 'pointer', fontFamily: 'Josefin Sans', width: { xs: '100%', sm: 'fit-content' }, boxSizing: { xs: 'border-box' }, padding: { xs: '5px' }, textAlign: 'center' }}
              >
                BookStore
              </Typography>
              <Typography
                ...
                noWrap
                component="div"
                sx={{ display: { xs: 'block', sm: 'block' }, "&:hover": { backgroundColor: { xs: '#7688dd' }, borderRadius: { xs: '5px' } }, marginRight: { md: "10px" }, cursor: 'pointer', fontFamily: 'Josefin Sans', width: { xs: '100%', sm: 'fit-content' }, boxSizing: { xs: 'border-box' }, padding: { xs: '5px' }, textAlign: 'center' }}
              >
                About
              </Typography>
              <Typography
              ...
              <Typography
                ...
                component="div"
                sx={{ display: admin ? { xs: 'block', sm: 'block' } : 'none', "&:hover": { backgroundColor: { xs: '#7688dd' }, borderRadius: { xs: '5px' } }, marginRight: { md: "10px" }, cursor: 'pointer', fontFamily: 'Josefin Sans', width: { xs: '100%', sm: 'fit-content' }, boxSizing: { xs: 'border-box' }, padding: { xs: '5px' }, textAlign: 'center' }}
              >
                Users
              </Typography>
              <Typography
